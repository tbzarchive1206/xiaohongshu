...
export function XiaohongshuArchive({ data }: { data: Archive }) {
  ...
  return <main id="top">
    <header className="masthead">
      <div className="utility"><a className="brand" href="https://tbzarchive.com/">THE BOYZ / FAN ARCHIVE</a><nav><span>XIAOHONGSHU MEDIA</span><span>/</span><a href="https://x.com/tbzarchive1206_" target="_blank" rel="noreferrer">TWITTER ↗</a></nav></div>
